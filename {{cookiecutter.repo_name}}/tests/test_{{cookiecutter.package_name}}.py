...
from {{cookiecutter.package_name}} import R, logger, clear_log, dump_log, logger_handler
from {{cookiecutter.package_name}}.__main__ import main, _create_file_handler
...
def test_main_uses_logger_handler():
    with mock.patch('{{cookiecutter.package_name}}.__main__.logger_handler') as logger_handler_:
        with mock.patch('{{cookiecutter.package_name}}.__main__._create_file_handler') as _create_file_handler_:
