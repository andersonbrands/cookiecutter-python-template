...
from {{cookiecutter.package_name}}.cli import Args, _cli_callable_from_params, cli
from {{cookiecutter.package_name}}.cli.api import version_method, clear_log_method, dump_log_method
...
def test_cli_calls_cli_callable_from_params():
    with mock.patch('{{cookiecutter.package_name}}.cli._cli_callable_from_params') as cli_callable:
        cli()
